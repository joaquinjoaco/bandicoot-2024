    ...
    return (
        <div>
            ...
            >
                ...
                <div className="bg-orange-500 text-white font-normal rounded-xl my-2 py-2 px-4 lg:group-hover:rounded-t-none lg:group-hover:-translate-y-1/2 lg:group-hover:opacity-0 transition-all">
                    {title}
                </div>
            </Link>
        </div>
